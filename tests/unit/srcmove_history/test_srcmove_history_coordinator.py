...
from srcmove_history.contracts import PairOutcome, PairStatus, PairWorkItem
from srcmove_history.coordinator import (
    CoordinatorStats,
...
class RunPairsTests(unittest.TestCase):
    ...
    def test_worker_count_is_fixed_and_each_item_executes_once(self) -> None:
        ...
        self.assertFalse(
            any(
                thread.name.startswith("srcmove-history-worker-")
