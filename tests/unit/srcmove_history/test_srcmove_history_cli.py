...
from srcmove_history.cli import (
    _render_pair,
    _status_document,
    build_parser,
    main,
)
from srcmove_history.configuration import (
    load_history_configuration,
    render_history_configuration,
)
from srcmove_history.locking import AnalysisOperationLock
from srcmove_history.inputs import AnalysisConfiguration, RepositoryIdentity
from srcmove_history.worker import PairExecutor
    ...
    def test_frozen_configuration_cannot_be_overridden(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            analysis_settings = replace(
                ...
                selected_directory="srcmove_history",
            )
