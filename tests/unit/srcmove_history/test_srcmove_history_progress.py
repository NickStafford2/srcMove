...
from srcmove_history.contracts import PairStatus
from srcmove_history.progress import (
...
class SrcMoveHistoryProgressTests(unittest.TestCase):
    ...
    def test_live_progress_has_spinner_bar_and_delayed_eta(self) -> None:
        ...
        clock = Clock()
        output = _LiveOutput()
        with patch("srcmove_history.progress.time.monotonic", clock):
            with TerminalAnalysisObserver(
