...
Runs in 10x the speed of srcDiff

# Status

It does everything I expect
Catches all identical code blocks.

- within file or across files
- Can detect whitespace differences
- Limited by the output of srcDiff.
  srcDiff may not mark blocks in ideal locations.

configurable

- select min granularity
- selects leaf only mode.

# Large Test Suite

lots of custom tests.

- integration and e2e

Trouble is that in real repos, moves were quite rare.
