...
If srcMove was called between commits 0 and 2, srcMove would not detect a move at all. But in the true history, foo was moved and altered. For this reason, I developed the srcmove_history srcMove tool. 


## srcmove_history srcMove tool
