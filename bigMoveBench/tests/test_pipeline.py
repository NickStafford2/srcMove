...
FIXTURE = REPO_ROOT / "bigMoveBench" / "tests" / "fixtures" / "bigclonebench_cases.json"
...
class BigCloneBenchPipelineTests(unittest.TestCase):
    ...
    def test_combined_result_report_separates_oracle_and_tool_outcomes(self) -> None:
        ...
        self.assertIn("BigMoveBench result: FAIL", report)
...
"""
            ...
            for summary in summaries:
                ...
                self.assertIn("type3_both_similarity", wrong)
                self.assertIn("type3_strength_stratum", wrong)
