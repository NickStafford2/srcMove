...
[`bigMoveBench/docs/methodology.md`](../methodology.md).
Operational commands remain in
[`bigMoveBench/README.md`](../../README.md).
...
```text
bigMoveBench/cache/bigclonebench/compiled/<dataset-id>/
  manifest.json
  catalog.sqlite
  fragments/
    <sha256>.java
...
BigMoveBench suite
  ...
  Type 1                 PASS|FAIL  passed ...   srcMove time ...
                         detected ... wrong class ... misses ... errors ...
  Type 2                 PASS|FAIL  passed ...   srcMove time ...
                         detected ... wrong class ... misses ... errors ...
  Type 3 very strong     PASS|FAIL  passed ... detected ... classified ...
  Type 3 strong          PASS|FAIL  passed ... detected ... classified ...
  Type 3 moderate        PASS|FAIL  passed ... detected ... classified ...
  Weak/semantic          PASS|FAIL  passed ... detected ... classified ...
  Known false positives PASS|FAIL  passed ... rejected ... accepted ... incidental ...

  selected cases ...   source rows ...   srcDiff eligible ...
  srcMove total ...  throughput ...    peak memory ...
```

Progress counters label execution explicitly. A completed `100/100` execution
must not be presented as or mistaken for `100/100` oracle passes.
...
`bigMoveBench/compile.py` and
`catalog.py` provide serial H2 export and the immutable SQLite/fragment
