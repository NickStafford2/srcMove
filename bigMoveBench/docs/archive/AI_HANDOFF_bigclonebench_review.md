...
- [bigMoveBench/generate.py](/home/nick/Projects/srcMLBuildTemplate/srcMove/bigMoveBench/generate.py:1)
- [bigMoveBench/run.py](/home/nick/Projects/srcMLBuildTemplate/srcMove/bigMoveBench/run.py:1)
- [bigMoveBench/README.md](/home/nick/Projects/srcMLBuildTemplate/srcMove/bigMoveBench/README.md:1)
- [bigMoveBench/docs/methodology.md](/home/nick/Projects/srcMLBuildTemplate/srcMove/bigMoveBench/docs/methodology.md:1)
...
```bash
python3 bigMoveBench/run.py --clone-type type1 --limit 100
```

Run Type-2:

```bash
python3 bigMoveBench/run.py --clone-type type2 --limit 100
```
...
4. Validates expected move count, match kind, and generated source/target line
   range overlap.
5. Writes `bigMoveBench/cases/summary.csv`.
