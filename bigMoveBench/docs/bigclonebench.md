...
```text
bigMoveBench/data/BigCloneEval/ijadataset/<functions.type>/<functions.name>
```
...
`bigMoveBench/data/BigCloneEval/ReadMe.md`, or the upstream README at
...
bigMoveBench/data/BigCloneEval/libs/h2-1.3.176.jar
```
...
bigMoveBench/data/BigCloneEval/ijadataset/bcb_reduced/*/{default,sample,selected}/*.java
```
