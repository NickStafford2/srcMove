# srcMove Handoff: srcMove History Phase 5 Prerequisites
...
- `AGENTS.md`
- `srcmove_history/docs/runtime.md`, especially “History and pair
  definition,” “Resume and cache safety,” and Phase 5
- `srcmove_history/contracts.py`
- `srcmove_history/git.py`
- `srcmove_history/resume.py`
...
```text
44 focused srcmove-history tests passed
