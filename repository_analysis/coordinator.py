...
class CoordinatorStats:
    """Constant-size observations from one completed coordinator run."""
...
class Coordinator:
    """Run a fixed worker pool over a sequence of commit-pair work."""
    ...
    def __init__(
        ...
        *,
        ...
        self._work_queue_capacity = work_capacity
        self._outcome_capacity = pending_capacity
    ...
    def run(
        ...
        work_queue: queue.Queue[PairWorkItem] = queue.Queue(
